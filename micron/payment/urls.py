...
from payment.views import CanceledTemplateView, SuccessTemplateView, payment_process, select_payment, paypal_process, paypal_execute, liqpay_process, liqpay_callback
...
urlpatterns = [
    ...
    path("liqpay-process/", liqpay_process, name="liqpay-process"),
